...
export default function IMGestaoHomepage() {
  const services = [
    {
  ...
  const insights = [
    {
      title: "Estratégia sem governança não escala",
      category: "Governança",
    },
    {
      title: "Como transformar prioridades em execução organizada",
      category: "Gestão",
    },
    {
      title: "Transformação organizacional exige método, não apenas intenção",
            ...
            <div className="max-w-3xl">
              ...
              <div className="mt-12 grid gap-5 sm:grid-cols-3">
                <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                  <div className="text-2xl font-semibold text-slate-950">Estratégia</div>
                  <p className="mt-2 text-sm leading-6 text-slate-600">
                    Definição de prioridades, objetivos e caminhos de evolução.
                  </p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                  <div className="text-2xl font-semibold text-slate-950">Governança</div>
                  <p className="mt-2 text-sm leading-6 text-slate-600">
                    Estruturas de gestão para transformar intenção em execução disciplinada.
                  </p>
                </div>
                <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                  <div className="text-2xl font-semibold text-slate-950">Transformação</div>
                  <p className="mt-2 text-sm leading-6 text-slate-600">
                    Mudanças organizacionais orientadas por método, consistência e resultado.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="rounded-[2rem] border border-slate-200 bg-slate-950 p-8 text-white shadow-2xl shadow-slate-300/40">
                ...
                <div className="mt-10 rounded-2xl border border-white/10 bg-white/5 p-5">
                  ...
                  <p className="mt-3 text-sm leading-7 text-slate-200">
                    Empresas que precisam reorganizar prioridades, fortalecer sua gestão, sustentar crescimento ou conduzir processos de transformação com maior maturidade executiva.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section id="insights" className="mx-auto max-w-7xl scroll-mt-28 px-6 py-20 lg:px-8">
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-3xl">
              ...
              <h2 className="mt-4 text-3xl font-semibold tracking-tight text-slate-950 md:text-4xl">
                Conteúdo para reforçar visão, repertório e autoridade executiva.
              </h2>
            </div>
            <div className="text-sm text-slate-500">Em breve: artigos, análises e publicações.</div>
          </div>
            ...
            {insights.map((item) => (
              ...
              >
                ...
                <p className="mt-4 text-sm leading-7 text-slate-600">
                  Reflexões aplicadas sobre gestão, estratégia e transformação para organizações que operam em contextos de maior exigência.
                </p>
              </article>
            ))}
          </div>
